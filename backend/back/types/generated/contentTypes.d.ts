...
export interface ApiConversationConversation
  ...
  info: {
    description: 'A chat session between a user and one or more models';
...
export interface ApiMachineMachine extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A developer machine running Ollama, exposed via Cloudflare Tunnel';
    displayName: 'Machine';
    pluralName: 'machines';
...
export interface ApiModelModel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An Ollama model available on a Machine';
    displayName: 'Model';
    pluralName: 'models';
    singularName: 'model';
  };
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    paramSize: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'A label that can be applied to conversations';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
